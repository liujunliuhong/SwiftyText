//
//  BaseTextStrokeViewController.swift
//  SwiftyText
//
...
class BaseTextStrokeViewController: BasePageViewController {
...
extension BaseTextStrokeViewController {
    override func makeUI() {
        ...
        atr1.st_add(strokeColor: .red)
        atr1.st_add(strokeWidth: NSNumber(value: 2))
        ...
        atr2.st_add(strokeColor: .purple)
        atr2.st_add(strokeWidth: NSNumber(value: 5))
        ...
        atr3.yy_setStroke(.purple, range: NSRange(location: 0, length: atr2.length))
        atr3.yy_setStrokeWidth(NSNumber(value: 5), range: NSRange(location: 0, length: atr2.length))
